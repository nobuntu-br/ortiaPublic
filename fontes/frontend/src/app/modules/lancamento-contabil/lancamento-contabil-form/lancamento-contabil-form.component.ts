...
import { LancamentoContabilService } from "../shared/lancamento-contabil.service"; 
...
@Component({
  selector: 'app-details-lancamento-contabil',
  templateUrl: './lancamento-contabil-form.component.html',
  styleUrls: ['./lancamento-contabil-form.component.scss']
})
export class LancamentoContabilFormComponent extends BaseResourceFormComponent<LancamentoContabil> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.lancamentoContabilJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected lancamentoContabilService: LancamentoContabilService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new LancamentoContabil(), lancamentoContabilService, LancamentoContabil.fromJson);//Linha alterável com base na classe 
