...
import { CotacaoMoedaService } from "../shared/cotacao-moeda.service"; 
...
@Component({
  selector: 'app-details-cotacao-moeda',
  templateUrl: './cotacao-moeda-form.component.html',
  styleUrls: ['./cotacao-moeda-form.component.scss']
})
export class CotacaoMoedaFormComponent extends BaseResourceFormComponent<CotacaoMoeda> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.cotacaoMoedaJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected cotacaoMoedaService: CotacaoMoedaService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new CotacaoMoeda(), cotacaoMoedaService, CotacaoMoeda.fromJson);//Linha alterável com base na classe 
