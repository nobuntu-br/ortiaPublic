...
import { PlanoDeContasService } from "../shared/plano-de-contas.service"; 
...
@Component({
  selector: 'app-details-plano-de-contas',
  templateUrl: './plano-de-contas-form.component.html',
  styleUrls: ['./plano-de-contas-form.component.scss']
})
export class PlanoDeContasFormComponent extends BaseResourceFormComponent<PlanoDeContas> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.planoDeContasJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected planoDeContasService: PlanoDeContasService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new PlanoDeContas(), planoDeContasService, PlanoDeContas.fromJson);//Linha alterável com base na classe 
