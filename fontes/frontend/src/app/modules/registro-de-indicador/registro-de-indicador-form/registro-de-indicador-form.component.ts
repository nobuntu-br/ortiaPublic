...
import { RegistroDeIndicadorService } from "../shared/registro-de-indicador.service"; 
...
@Component({
  selector: 'app-details-registro-de-indicador',
  templateUrl: './registro-de-indicador-form.component.html',
  styleUrls: ['./registro-de-indicador-form.component.scss']
})
export class RegistroDeIndicadorFormComponent extends BaseResourceFormComponent<RegistroDeIndicador> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.registroDeIndicadorJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected registroDeIndicadorService: RegistroDeIndicadorService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new RegistroDeIndicador(), registroDeIndicadorService, RegistroDeIndicador.fromJson);//Linha alterável com base na classe 
