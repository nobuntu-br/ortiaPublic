...
import { HistoricoPadraoService } from "../shared/historico-padrao.service"; 
...
@Component({
  selector: 'app-details-historico-padrao',
  templateUrl: './historico-padrao-form.component.html',
  styleUrls: ['./historico-padrao-form.component.scss']
})
export class HistoricoPadraoFormComponent extends BaseResourceFormComponent<HistoricoPadrao> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.historicoPadraoJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected historicoPadraoService: HistoricoPadraoService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new HistoricoPadrao(), historicoPadraoService, HistoricoPadrao.fromJson);//Linha alterável com base na classe 
