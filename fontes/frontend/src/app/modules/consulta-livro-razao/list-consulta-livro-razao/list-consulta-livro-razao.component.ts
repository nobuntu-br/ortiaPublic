...
@Component({
  selector: 'app-list-consulta-livro-razao',
  templateUrl: './list-consulta-livro-razao.component.html',
  styleUrls: ['./list-consulta-livro-razao.component.scss']
})
export class ListConsultaLivroRazaoComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.ConsultaLivroRazaoAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
