...
import { UsuarioDoEstabelecimentoService } from "../shared/usuario-do-estabelecimento.service"; 
...
@Component({
  selector: 'app-details-usuario-do-estabelecimento',
  templateUrl: './usuario-do-estabelecimento-form.component.html',
  styleUrls: ['./usuario-do-estabelecimento-form.component.scss']
})
export class UsuarioDoEstabelecimentoFormComponent extends BaseResourceFormComponent<UsuarioDoEstabelecimento> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.usuarioDoEstabelecimentoJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected usuarioDoEstabelecimentoService: UsuarioDoEstabelecimentoService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new UsuarioDoEstabelecimento(), usuarioDoEstabelecimentoService, UsuarioDoEstabelecimento.fromJson);//Linha alterável com base na classe 
