...
import { CentroDeCustoService } from "../shared/centro-de-custo.service"; 
...
@Component({
  selector: 'app-details-centro-de-custo',
  templateUrl: './centro-de-custo-form.component.html',
  styleUrls: ['./centro-de-custo-form.component.scss']
})
export class CentroDeCustoFormComponent extends BaseResourceFormComponent<CentroDeCusto> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.centroDeCustoJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected centroDeCustoService: CentroDeCustoService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new CentroDeCusto(), centroDeCustoService, CentroDeCusto.fromJson);//Linha alterável com base na classe 
