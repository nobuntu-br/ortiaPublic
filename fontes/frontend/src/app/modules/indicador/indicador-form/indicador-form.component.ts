...
import { IndicadorService } from "../shared/indicador.service"; 
...
@Component({
  selector: 'app-details-indicador',
  templateUrl: './indicador-form.component.html',
  styleUrls: ['./indicador-form.component.scss']
})
export class IndicadorFormComponent extends BaseResourceFormComponent<Indicador> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.indicadorJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected indicadorService: IndicadorService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new Indicador(), indicadorService, Indicador.fromJson);//Linha alterável com base na classe 
