...
export class ListIndicadorComponent implements AfterViewInit,  OnDestroy  {
  ...
  userConfig; 
  searchableFields = [] 
  //apiURL: string = environment.IndicadorAPIPath;//Campo que é alterável, o nome do campo "variations"+"APIPATH". 
  JSONURL: string = environment.indicadorJSONPath;// Campo que é alterável, o nome do campo "variations"+"JSONPATH". 
  /** 
