...
@Component({
  selector: 'app-details-estabelecimento',
  templateUrl: './estabelecimento-form.component.html',
  styleUrls: ['./estabelecimento-form.component.scss']
})
export class EstabelecimentoFormComponent extends BaseResourceFormComponent<Estabelecimento> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.estabelecimentoJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected estabelecimentoService: EstabelecimentoService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new Estabelecimento(), estabelecimentoService, Estabelecimento.fromJson);//Linha alterável com base na classe 
